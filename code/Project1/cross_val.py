...
def cv_optimize(clf, X_train, Y_train, param_grid):
    gs = GridSearchCV(clf, param_grid = param_grid, scoring = 'mean_squared_error', cv = KFold(X_train.shape[0], n_folds = 10, shuffle = True, random_state = 78), n_jobs = 7, verbose = 3)
